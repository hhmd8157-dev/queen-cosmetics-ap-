...
// قائمة المنتجات الـ 103 الحقيقية مع الأسماء والتفاصيل والأسعار الفعلية المطابقة 100% للصورة
...
console.log("Successfully updated src/data/products.ts with complete STORE_INFO!");
